...
function showToast(type, title, message) {
  ...
  toast.style.cssText = `
    ...
    z-index: 10000; border-right: 5px solid ${colors[type]};
    transition: all 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55);
    font-family: 'Segoe UI', Tahoma, sans-serif;
  `;
  toast.innerHTML = `
    <div style="width:48px;height:48px;border-radius:50%;background:${colors[type]}15;
    ...
    <button onclick="this.parentElement.remove()" style="background:none;border:none;
      color:#9ca3af;cursor:pointer;font-size:20px;padding:4px">×</button>
  `;
